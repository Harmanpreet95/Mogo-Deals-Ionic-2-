...
export class  Edit_profilePage {
  ...
  constructor(public navCtrl: NavController,public nav : Nav,private camera: Camera,public loadingCtrl:LoadingController,public actionSheetCtrl: ActionSheetController,public toastCtrl: ToastController,public appsetting : Appsetting ,public http: Http,public variable: VariableProvider,private twitter: TwitterConnect,   private googlePlus: GooglePlus,  public afAuth: AngularFireAuth,public events : Events, public alertCtrl: AlertController,private facebook: Facebook) {
        this.showProfile();
